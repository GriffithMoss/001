        ...
        <div className="grid grid-cols-2 md:col-span-2 gap-8">
            <div>
                ...
                <ul className="mt-4 space-y-2">
                    <li><a href="#" className="hover:text-indigo-400 transition-colors">すべての商品</a></li>
                    <li><a href="#" className="hover:text-indigo-400 transition-colors">ペン＆鉛筆</a></li>
                    <li><a href="#" className="hover:text-indigo-400 transition-colors">ノート</a></li>
                    <li><a href="#" className="hover:text-indigo-400 transition-colors">デスクアクセサリー</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul className="mt-4 space-y-2">
                    ...
                    <li><a href="#" className="hover:text-indigo-400 transition-colors">よくある質問</a></li>
                    <li><a href="#" className="hover:text-indigo-400 transition-colors">配送について</a></li>
                    <li><a href="#" className="hover:text-indigo-400 transition-colors">返品について</a></li>
                </ul>
            </div>
        </div>
